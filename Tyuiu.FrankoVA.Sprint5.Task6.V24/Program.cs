using Tyuiu.FrankoVA.Sprint5.Task6.V24.Lib;
namespace Tyuiu.FrankoVA.Sprint5.Task6.V24
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            string path = Path.Combine(Path.GetTempPath(), "DataSprint5", "InPutDataFileTask6V24.txt");
            Console.WriteLine("***************************************************************************");
